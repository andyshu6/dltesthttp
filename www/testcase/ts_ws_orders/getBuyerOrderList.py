...
class getBuyerOrderList(unittest.TestCase):
    ...
    def assertOrderList(self, rsq, order, merch, payType='2', paymentOrderButtomList='00020', buttomList='000000'):
        ...
        for i in range(0, len(rsq.model['paymentOrderList'])):
            if rsq.model['paymentOrderList'][i]['paymentNo'] == order.paymentNo:
                ...
                self.assertEqual(rsq.model['paymentOrderList'][i]['paymentPayStatus'], 'normal')
