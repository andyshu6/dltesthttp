...
class preSeparateOrder(unittest.TestCase):
    ...
    def test_preSeparateOrder_codWaitDeliver(self):
        ...
        self.assertPreSepOrder(sepOrder, self.UserShop.orderCodWaitDeliver, self.UserShop)
    ...
    def test_preSeparateOrder_codWaitReceive(self):
        ...
        self.assertEqual(sepOrder.model['success'], '0')
        self.assertPreSepOrder(sepOrder, self.UserShop.orderCodWaitReceive, self.UserShop)
    ...
    def test_preSeparateOrder_codWaitComplete(self):
        ...
        self.assertEqual(sepOrder.model['success'], '0')
        self.assertPreSepOrder(sepOrder, self.UserShop.orderCodComplete, self.UserShop)
    ...
    def test_preSeparateOrder_codWaitCancel(self):
        ...
        self.assertEqual(sepOrder.model['success'], '0')
        self.assertPreSepOrder(sepOrder, self.UserShop.orderCodCancel, self.UserShop)
    ...
    def test_preSeparateOrder_onlineWaitPay(self):
        ...
        self.assertEqual(sepOrder.model['success'], '0')
        self.assertPreSepOrder(sepOrder, self.UserShop.orderOnlineWaitPay, self.UserShop)
    ...
    def assertPreSepOrder(self, rsp, order, buyer):
        self.assertEqual(rsp.model['orderNo'], order.orderNo)
        self.assertEqual(rsp.model['orderAmount'], order.price)
        self.assertEqual(rsp.model['separateOrderTimes'], buyer.separateOrderTimes)
        self.assertEqual(rsp.model['buyerName'], buyer.fullName)


    def tearDown(self):
        update('update dlcompany.dl_payment_split_info set min_amount = ? where company_id = ?', '10000', self.DealMager.companyId)
