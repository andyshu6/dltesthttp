...
class getSellerOrderDetail(unittest.TestCase):
    ...
    def test_getSellerOrderDetail_codWaitReceive(self):
        orderDetail = self.wsDealMager.getBuyerOrderDetail(orderPk=self.UserShop.orderCodWaitReceive.paymentNo, orderNo=self.UserShop.orderCodWaitReceive['orderNo'])
        self.assertEqual(orderDetail.model['success'], '0')
    ...
    def test_getSellerOrderDetail_codCancel(self):
        orderDetail = self.wsDealMager.getBuyerOrderDetail(orderPk=self.UserShop.orderCodCancel.paymentNo, orderNo=self.UserShop.orderCodCancel['orderNo'])
        self.assertEqual(orderDetail.model['success'], '0')
    ...
    def test_getSellerOrderDetail_onlineWaitPay(self):
        orderDetail = self.wsDealMager.getBuyerOrderDetail(orderPk=self.UserShop.orderOnlineWaitPay.paymentNo, orderNo=self.UserShop.orderOnlineWaitPay['orderNo'])
        self.assertEqual(orderDetail.model['success'], '0')
    ...
    def test_getSellerOrderDetail_onlineCancel(self):
        orderDetail = self.wsDealMager.getBuyerOrderDetail(orderPk=self.UserShop.orderOnlienCancel.paymentNo, orderNo=self.UserShop.orderOnlienCancel['orderNo'])
        self.assertEqual(orderDetail.model['success'], '0')
    ...
    def assertOrderDetail(self, rsq, order, buyer, merch, buttomList='00000100'):
        ...
        if rsq.model['orderDetail']['payTime'] is None:
            ...
            self.assertEqual(rsq.model['orderDetail']['payTime'], paymentOrder.pay_time)
        ...
        self.assertEqual(rsq.model['orderDetail']['merchList'][0]['picUrl'], merch.picUrl)
